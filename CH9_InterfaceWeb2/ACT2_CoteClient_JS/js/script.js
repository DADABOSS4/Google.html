...
let para=document.querySelector("#para");
para.addEventListener('mouseenter',entreeSouris);   /* Déclenche la fct entreesouris au survol (arrivée)*/
para.addEventListener('mouseleave',sortieSouris);  /* Déclenche la fct sortiesouris au survol (sortie)*/


/*Evenements sur les boutons plus petit et plus grand */
/* Id = style dans le html*/
...
/* balise img dans le html*/

function fonctionClicImage(){
	image=document.querySelector("img");
		if (i==0){
			image.setAttribute("src","img/image2.jpeg");
			i=1;
		}
	else {
			image.setAttribute("src","img/image1.jpeg");
			i=0;
		}
	}
